...
<head>
    ...
    <title><?php echo $type === 'invoice' ? 'Invoice' : 'Statement of Account'; ?></title>
    <style>
        body {
...
<body>
    <div class="statement-container">
        ...
        <div class="statement-title"><span><?php echo $type === 'invoice' ? 'INVOICE' : 'STATEMENT OF ACCOUNT'; ?></span></div>
        ...
        <?php else : ?>
            <table class="account-summary">
                <tbody>
                    <tr>
                        <td class="blue-bg"><strong>Status</strong></td>
                        <td><?php echo htmlspecialchars($user['status']); ?></td>
                    </tr>
                    <tr>
                        <td class="blue-bg"><strong>Total Amount Due</strong></td>
                        <td>Php<?php echo htmlspecialchars(number_format($user['payment'], 2)); ?></td>
                    </tr>
                </tbody>
            </table>
        <?php endif; ?>
